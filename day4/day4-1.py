...
maxim_slept = 0
for i in range(60):
    if time_dict[guard_maxim][i] > maxim_slept:
        maxim_slept = time_dict[guard_maxim][i]
        minute_maxim_slept = i


print(minute_maxim_slept*guard_maxim)
